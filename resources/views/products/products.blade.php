...
@section('content')
    ...
    <div class="row row-sm">
        ...
        @if (session()->has('Add'))
            <div class="alert alert-success alert-dimsissible fade show col-2 mr-2" role="alret">
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between col-2">
                        <a class="modal-effect btn ripple btn-teal btn-block" data-effect="effect-scale" data-toggle="modal"
            ...
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-body">
                    <form action="{{ route('products.store') }}" method="POST">
                        ...
                        <label class="my" for="inlineFormCustomSelectPref">القسم</label>
                        <select class="form-control" name="section_id" id="section_id" required>
                            <option value="" selected disabled># قم بأختيار القسم</option>
                        ...
                        <div class="modal-footer">
                            <button class="btn ripple btn ripple btn-teal" type="submit">أضافة</button>
                ...
                <div class="modal-body">
                    <form action="products/update" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="id" id="id" value="897">
                            <input class="form-control" name="product_name" id="product_name" type="text">
                        </div>

                        <label class="my-1 mr-2" for="inlineFormCustomSelectPref">القسم</label>
                        <select class="form-control" name="section_id" id="section_id" required>
                            {{-- <option value="" selected disabled name="section_name" id="section_name"></option> --}}
                            @foreach ($section as $item)
